  ...
  return (
    <PageTransition>
      <div className="min-h-screen pt-20">
        ...
        <section className="relative bg-gradient-to-br from-gray-50 via-primary-50 to-gray-100 dark:from-gray-900 dark:via-primary-900 dark:to-gray-900 py-20 sm:py-28 overflow-hidden">
          {/* Animated Background */}
