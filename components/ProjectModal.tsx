      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            transition={{ duration: 0.2 }}
            className="bg-white dark:bg-gray-900 rounded-xl sm:rounded-2xl max-w-4xl w-full max-h-[85vh] sm:max-h-[88vh] md:max-h-[90vh] overflow-y-auto relative shadow-2xl border border-gray-200 dark:border-gray-800"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Close Button */}
            <button
              onClick={onClose}
              className="absolute top-4 right-4 z-50 bg-white/95 dark:bg-gray-900/95 text-gray-800 dark:text-white p-2.5 sm:p-3 md:p-3.5 rounded-full hover:bg-white dark:hover:bg-gray-800 transition-all shadow-lg backdrop-blur-sm border border-gray-200 dark:border-gray-800"
            ...
            {/* Image Gallery */}
            <div className="relative bg-gray-100 dark:bg-gray-950 overflow-hidden rounded-t-xl sm:rounded-t-2xl">
