...
const ServicesPage = () => {
  ...
  const additionalServices = [
    ...
    },
    {
      name: 'Logo დიზაინი',
      price: '200-500 ₾',
      description: 'პროფესიონალური ლოგოს შექმნა'
    },
    {
      name: 'კონტენტის შექმნა',
      price: '100-300 ₾/გვერდი',
      description: 'SEO ოპტიმიზირებული ტექსტები'
    },
    {
      name: 'ფოტოგრაფია',
      price: '300-800 ₾',
      description: 'პროფესიონალური ფოტო სესია'
    },
    {
      name: 'მენტენანსი',
      price: '200-500 ₾/თვე',
      description: 'რეგულარული განახლებები და მხარდაჭერა'
    }
  ]
